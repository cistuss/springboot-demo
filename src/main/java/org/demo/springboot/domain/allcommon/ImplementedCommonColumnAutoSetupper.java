...
public class ImplementedCommonColumnAutoSetupper implements CommonColumnAutoSetupper {
    ...
    protected void doHandleCommonColumnOfInsertIfNeeds(EntityDefinedCommonColumn entity) {
        final java.time.LocalDateTime createDatetime = org.dbflute.hook.AccessContext.getAccessLocalDateTimeOnThread();
        entity.setCreateDatetime(createDatetime);
        final java.time.LocalDateTime updateDatetime = entity.getCreateDatetime();
