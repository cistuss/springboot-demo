 ...
 */
@Configuration
@ComponentScan(value="org.demo.springboot.domain.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new org.demo.springboot.domain.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new org.demo.springboot.domain.dbflute.allcommon.ImplementedInvokerAssistant();
    }
